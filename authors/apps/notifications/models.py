...
class NotificationManager(models.Manager):
    ...
    def create_notification(self, sender=None, notification_body=None, classification=None): # noqa
    ...
    def mark_all_as_read(self, subscriber=None):
        ...
        for notification in notifications:
            if not Notification.objects.filter(pk=notification.id, read=subscriber.pk).exists(): # noqa
