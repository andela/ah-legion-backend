...
class NotificationDispatcher:
    ...
    def article_published(self, request, instance):
        ...
        body = "Hello there, {}, just created a new article titled: '{}'".format( # noqa
    ...
    def user_followed(self, request, followed):
        ...
        body = "Hello there {}, you are getting popular. {} just folowed you.".format( # noqa
    ...
    def article_commented(self, request, instance):
        ...
        of a comment
        """
        body = "Hello there, this artcle titled:'{}', has been commented on. Here is the comment: '{}'".format( # noqa
    ...
    def article_favourited(self, request, instance):
        ...
        of a favourite
        """
        body = "Hello there {}. {} favourited your article titled: '{}' ".format(  # noqa
            instance.article_id.author.user.username,
            request.user.username,
            instance.article_id.title.title()
        )
    ...
    def comment_commented(self, request, instance):
        ...
        body = "Hello there. {} commented on this comment '{}' with '{}'".format(  # noqa
            request.user.username,
